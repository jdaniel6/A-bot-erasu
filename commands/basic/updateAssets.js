        ...
        if (interaction.user.id === myID || interaction.user.id === mythID) {
            try {
                ...
                for (const s2item of s2itemsArray) {
                    ...
                    fs.mkdirSync(filePath, { recursive: true });
                    fs.writeFileSync(`${filePath}/${s2item['internalName']}.json`, JSON.stringify(s2item, null, 4), 'utf8');
                    ...
                    fs.writeFileSync(`${filePath}/${s2item['internalName']}.webp`, itemBuffer);
                }
                ...
                for (const s2god of s2godsArray) {
                    ...
                    fs.mkdirSync(filePath, { recursive: true });
                    fs.writeFileSync(`${filePath}/${s2god['name']}.json`, JSON.stringify(s2god, null, 4), 'utf8');
                    //god Icon
                    ...
                    fs.writeFileSync(`${filePath}/${s2god['name']}.webp`, godBuffer);
                    //god basic icon
                    ...
                    fs.writeFileSync(`${filePath}/${s2god['name']}Basic.webp`, godBasicBuffer);
                    //god passive icon
                    ...
                    fs.writeFileSync(`${filePath}/${s2god['name']}Passive.webp`, godPassiveBuffer);
                    //god a01 icon
                    ...
                    fs.writeFileSync(`${filePath}/${s2god['name']}A1.webp`, godA1Buffer);
                    //god a02 icon
                    ...
                    fs.writeFileSync(`${filePath}/${s2god['name']}A2.webp`, godA2Buffer);
                    //god a03 icon
                    ...
                    fs.writeFileSync(`${filePath}/${s2god['name']}A3.webp`, godA3Buffer);
                    //god a04 icon
                    ...
                    fs.writeFileSync(`${filePath}/${s2god['name']}A4.webp`, godA4Buffer);
                }
